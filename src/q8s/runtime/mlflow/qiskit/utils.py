...
def create_autolog(integration_name: str = "qiskit") -> Callable[..., None]:
    ...
    def autolog(
        ...
        This function is idempotent and can be called multiple times. The integration
...
def _patch_qiskit(
    ...
    def patched_staged_pass_manager_run(
        ...
        **kwargs,
        ...
        circuit: QuantumCircuit = args[0][0] if isinstance(args[0], list) else args[0]
    ...
    logger.debug("patched StagedPassManager.run")
    ...
    logger.debug("Patched generate_preset_pass_manager")
